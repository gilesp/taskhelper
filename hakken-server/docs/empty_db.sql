...
--
-- TOC entry 1949 (class 0 OID 85740)
-- Dependencies: 162
-- Data for Name: dataitems; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY dataitems (di_id, name, pagename, type, value) FROM stdin;
\.


--
-- TOC entry 1954 (class 0 OID 85816)
-- Dependencies: 167
-- Data for Name: dc_def_mapping_props; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY dc_def_mapping_props (dc_def_mapping_id, value, key) FROM stdin;
\.


--
-- TOC entry 1950 (class 0 OID 85748)
-- Dependencies: 163
-- Data for Name: dc_def_mappings; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY dc_def_mappings (id, dataconnectorname, taskdefinitionname) FROM stdin;
\.


--
-- TOC entry 1955 (class 0 OID 85829)
-- Dependencies: 168
-- Data for Name: service_mapping_dataitems; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY service_mapping_dataitems (mapping_id, task_di, connector_di) FROM stdin;
\.


--
-- TOC entry 1951 (class 0 OID 85756)
-- Dependencies: 164
-- Data for Name: service_mappings; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY service_mappings (id, taskdefinitionname, dc_def_mapping_id) FROM stdin;
\.


--
-- TOC entry 1952 (class 0 OID 85761)
-- Dependencies: 165
-- Data for Name: submission_dataitems; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY submission_dataitems (submission_id, data_item_id) FROM stdin;
\.


--
-- TOC entry 1953 (class 0 OID 85766)
-- Dependencies: 166
-- Data for Name: submissions; Type: TABLE DATA; Schema: hakken; Owner: hakken
--

COPY submissions (sub_id, job_id, taskdefinitionname, username) FROM stdin;
\.
